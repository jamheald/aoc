...
for (var i = 0; i<passwords.length; i++) {
    var passArray = passwords[i].split(' ');
    var numbers = passArray[0].split('-').map(x=>+x);
    var char = passArray[1][0];
    var password = passArray[2];

    var occur = password.split(char).length-1;

    n = n + (numbers[0]<=occur && numbers[1]>=occur);

    var char1 = password[numbers[0]-1];
    var char2 = password[numbers[1]-1];

    var kosh1 = char == char1;
    var kosh2 = char == char2;
